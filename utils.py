...
class BaseDriver:
    ...
    @classmethod
    def driver_get_url(cls,url):
        # 打开页面
        cls.open_driver().get(url)
...
class DataDriven:
    ...
    def create_dict(self,folder='/data',data_num=1):
        '''
        通过字典形式获取   {
                                "xxx":{
        ...
        data_dict = []
        # 获取json数据
        data = self.data_driver(folder,data_num)
    ...
    def create_list(self,folder='/data',data_num=1):
        '''
                通过字典形式获取   [
                                          {
                                            "xxx": "xxx",
    ...
    def create_values(self,values,folder='/data',data_num=1):
        '''
                获取单个键里面的值   {
                                "xxx":{
