...
class ActionsChains:
    ...
    def action_move_to_element_with_offset(self,element,location):
        '''
        鼠标悬停点击 （点触）
        :param element:
        :param location:
        :return:
        '''
        self.action_chains().move_to_element_with_offset(element,location[0],location[1]).click().perform()